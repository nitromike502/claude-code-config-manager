 ...
 *
 * Tests for the InlineEditField.vue component which provides inline editing
...
test.describe('InlineEditField Component', () => {
  ...
  test.describe('Display Mode', () => {
    test('renders value in display mode by default', async ({ page }) => {
      ...
      await expect(displayValue).toContainText('data-processor')
    })
    ...
    test('edit button is disabled when field is disabled', async ({ page }) => {
  ...
  test.describe('Edit Mode Activation', () => {
    ...
    test('input field receives focus when entering edit mode', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
  ...
  test.describe('Field Types', () => {
    test('text field - accepts and updates value', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
    ...
    test('textarea field - accepts multi-line text', async ({ page }) => {
    ...
    test('select field - changes dropdown selection', async ({ page }) => {
  ...
  test.describe('Validation', () => {
    ...
    test('stays in edit mode when validation fails', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
  ...
  test.describe('Keyboard Shortcuts', () => {
    test('Enter key accepts changes for text field', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
    ...
    test('Enter key does not accept changes for textarea', async ({ page }) => {
      const textareaField = page.locator('.test-box').filter({ hasText: 'Textarea Field' }).first()
      const editButton = textareaField.getByRole('button', { name: 'Edit Description' })
  ...
  test.describe('Accessibility', () => {
    test('edit button has proper aria-label', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
    ...
    test('accept and cancel buttons have aria-labels', async ({ page }) => {
      const textField = page.locator('.test-box').filter({ hasText: 'Text Field' }).first()
      const editButton = textField.getByRole('button', { name: 'Edit Agent Name' })
